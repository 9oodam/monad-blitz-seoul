    ...
    <div className="flex flex-col gap-3 p-4 bg-base-200 rounded-2xl">
      <div className="flex items-center justify-between gap-2">
        <div className="flex flex-col items-start">
          ...
          <div className="flex items-center gap-1">
            <span className="text-lg font-bold">{order.amountM}</span>
        ...
        <div className="flex flex-col items-end">
          ...
          <div className="flex items-center gap-1">
            <span className="text-lg font-bold">{order.amountT}</span>
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex justify-between">
          ...
          <span>      {new Date(parseInt(order.expiry.toString()) * 1000).toLocaleString()}
          </span>
        </div>
      </div>
    </div>
